...
takum8_from_float64(double f)
{
	if (f == 0.0) {
		...
		return takum8_from_takum32(codec_takum32_from_s_and_l(f < 0,
			2 * log(fabs(f))));
	}
}
...
takum16_from_float64(double f)
{
	if (f == 0.0) {
		...
		return takum16_from_takum32(codec_takum32_from_s_and_l(f < 0,
			2 * log(fabs(f))));
	}
}
...
takum64_from_float64(double f)
{
	if (f == 0.0) {
		...
		return codec_takum64_from_s_and_l(f < 0, (long double)(2 * log(fabs(f))));
	}
}
...
takum8_from_extended_float(long double f)
{
	if (f == 0.0L) {
		...
		return takum8_from_takum64(codec_takum64_from_s_and_l(f < 0,
			2 * logl(fabsl(f))));
	}
}
...
takum16_from_extended_float(long double f)
{
	if (f == 0.0L) {
		...
		return takum16_from_takum64(codec_takum64_from_s_and_l(f < 0,
			2 * logl(fabsl(f))));
	}
}
...
takum32_from_extended_float(long double f)
{
	if (f == 0.0L) {
		...
		return takum32_from_takum64(codec_takum64_from_s_and_l(f < 0,
			2 * logl(fabsl(f))));
	}
}
...
takum64 takum64_from_extended_float(long double f)
{
	if (f == 0.0L) {
		...
		return codec_takum64_from_s_and_l(f < 0,
			2 * logl(fabsl(f)));
	}
}
...
{
	return (t != 0) * (1 - 2 * (t < 0)) * powf(SQRTE, codec_takum16_to_l(t));
}

float
takum32_to_float32(takum32 t)
{
	return (t != 0) * (1 - 2 * (t < 0)) * powf(SQRTE, (float)codec_takum32_to_l(t));
}

float
takum64_to_float32(takum64 t)
{
	return (t != 0) * (1 - 2 * (t < 0)) * powf(SQRTE, (float)codec_takum64_to_l(t));
}
...
{
	return (t != 0) * (1 - 2 * (t < 0)) * pow(SQRTE, (double)codec_takum8_to_l(t));
}

double
takum16_to_float64(takum16 t)
{
	return (t != 0) * (1 - 2 * (t < 0)) * pow(SQRTE, (double)codec_takum16_to_l(t));
}
...
{
	return (t != 0) * (1 - 2 * (t < 0)) * pow(SQRTE, (double)codec_takum64_to_l(t));
}
...
{
	return (t != 0) * (1 - 2 * (t < 0)) * powl(SQRTE, (long double)codec_takum8_to_l(t));
}

long double
takum16_to_extended_float(takum16 t)
{
	return (t != 0) * (1 - 2 * (t < 0)) * powl(SQRTE, (long double)codec_takum16_to_l(t));
}

long double
takum32_to_extended_float(takum32 t)
{
	return (t != 0) * (1 - 2 * (t < 0)) * powl(SQRTE, (long double)codec_takum32_to_l(t));
}

long double
takum64_to_extended_float(takum64 t)
{
	return (t != 0) * (1 - 2 * (t < 0)) * powl(SQRTE, codec_takum64_to_l(t));
}
