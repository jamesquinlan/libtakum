...
takum8_multiplication(takum8 a, takum8 b)
{
	return codec_takum8_from_s_and_l(
		(a > 0) != (b > 0),
		codec_takum8_to_l(a) + codec_takum8_to_l(b)
	);
}
...
takum16_multiplication(takum16 a, takum16 b)
{
	return codec_takum16_from_s_and_l(
		(a > 0) != (b > 0),
		codec_takum16_to_l(a) + codec_takum16_to_l(b)
	);
}
...
takum32_multiplication(takum32 a, takum32 b)
{
	return codec_takum32_from_s_and_l(
		(a > 0) != (b > 0),
		codec_takum32_to_l(a) + codec_takum32_to_l(b)
	);
...
takum64_multiplication(takum64 a, takum64 b)
{
	return codec_takum64_from_s_and_l(
		(a > 0) != (b > 0),
		codec_takum64_to_l(a) + codec_takum64_to_l(b)
	);
}
